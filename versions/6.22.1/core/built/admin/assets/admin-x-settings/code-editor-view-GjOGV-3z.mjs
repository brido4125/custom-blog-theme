import { f as N, l as z, d as H, b as m, o as L, cO as O, g, n as B, j as r, cP as M, H as P, m as V } from "./index-7sHrjdF8.mjs";
const G = [
  ...
  return /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    ...
    u && /* @__PURE__ */ r.jsxs("div", { className: s === "full" ? "h-full" : "", style: { width: h }, children: [
      ...
      t && /* @__PURE__ */ r.jsx(P, { className: "text-grey-700! peer-focus:text-black! order-1", htmlFor: v, useLabelTag: !0, children: t }),
...
//# sourceMappingURL=code-editor-view-GjOGV-3z.mjs.map
