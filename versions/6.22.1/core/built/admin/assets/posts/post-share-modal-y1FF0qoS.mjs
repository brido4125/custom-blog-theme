import { u as k, j as e } from "./index-Co93OG_r.mjs";
import { g as N, B as a, l as w } from "./heading-Dvc5EWMZ.mjs";
import { g as C, h as y, i as z, X as M, j as H, k as $, l as P, m as D, C as I } from "./dialog-WtZBx3XK.mjs";
/**
    ...
    /* @__PURE__ */ e.jsxs(z, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      ...
      /* @__PURE__ */ e.jsx(D, { className: "justify-between gap-6", children: x ? /* @__PURE__ */ e.jsx(a, { className: "cursor-pointer", type: "submit", onClick: o, children: "Close" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { "aria-label": "Share on Facebook", className: "hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4", href: `https://www.facebook.com/sharer/sharer.php?u=${r}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 40 40", children: [
...
//# sourceMappingURL=post-share-modal-y1FF0qoS.mjs.map
