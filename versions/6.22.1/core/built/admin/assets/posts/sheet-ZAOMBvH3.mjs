import { D as i, j as t, W as x, n as o, T as f } from "./index-Co93OG_r.mjs";
import { R as h, f as g, b as u, d, e as b, X as y, T as n, D as l, O as r } from "./dialog-WtZBx3XK.mjs";
...
const j = f(
  ...
  /* @__PURE__ */ t.jsxs(
    d,
    {
      ...
      ...m,
      children: [
        /* @__PURE__ */ t.jsxs(b, { className: "fixed right-4 top-4 z-50 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [
...
//# sourceMappingURL=sheet-ZAOMBvH3.mjs.map
